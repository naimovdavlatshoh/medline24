...
import { AddKoyk } from "./AddKoyk";
import { EditKoyk } from "./EditKoyk";
...
const Koyk = () => {
    ...
    const DeleteFinish = () => {
        DeleteData(`api/koykatype/delete/${deleteId}`).then((res) => {
            setOpen(!open);
            setStatus(!status);
        });
    };
        ...
        <div>
            <Dialog className="text-theme-text bg-theme-bg" open={open} handler={handleOpen}>
                ...
                <DialogFooter>
                    ...
                    >
                        <span>
                            {language == "ru" ? Delete.rutrue : Delete.rufalse}
                        </span>
                    </Button>
                </DialogFooter>
            </Dialog>
