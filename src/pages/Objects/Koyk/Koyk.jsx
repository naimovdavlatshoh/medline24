...
import { AddKoyk_ } from "./AddKoyk";
import Pagination from "../../../components/Pagination";
import { Delete } from "../../../utils/constants";

const TABLE_HEAD = ["N", "Объект", "Палата", "Тип"];
const TABLE_HEADUZ = ["N", "Bino", "Palata", "Tur"];
...
const Koyk = () => {
    ...
    useEffect(() => {
        GetDataSimple("api/koyka/list?page=1&limit=10").then((res) => {
            setUsers(res?.result);
