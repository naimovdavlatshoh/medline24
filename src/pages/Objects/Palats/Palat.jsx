...
import { AddPalat } from "./AddPalat";
import { EditPalat } from "./EditPalat";
import Pagination from "../../../components/Pagination";

const TABLE_HEAD = ["N", "Объект", "Палата", "Отдел", "Действия"];
const TABLE_HEADUZ = ["N", "Bino", "Palata", "Bo'lim", "Amal"];
