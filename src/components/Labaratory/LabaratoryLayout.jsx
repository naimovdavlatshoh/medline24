...
import LabaratorySidebar from "./LabaratorySidebar";
import LabaratoryrNavbar from "./LabaratoryNavbar";

import { useState } from "react";
import { RiMenuUnfold3Fill } from "react-icons/ri";
import LabaratoryNavbar from "./LabaratoryNavbar";
import LabaratoryThemeToggle from "./LabaratoryThemeToggle";

const LabaratoryLayout = () => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex flex-col flex-grow  ">
                    ...
                    <div className="h-[10vh]">
                        <LabaratoryNavbar setTheme1={setTheme1} />
                    </div>
            ...
            >
                ...
                >
                    <LabaratorySidebar active={active} setActive={setActive} />
                </div>
                    ...
                    <div className="h-[10vh] ">
                        <div className="bg-theme-bg text-theme-text flex items-center justify-between px-3 h-[80px] transition-all duration-300">
                            ...
                            <div className="flex justify-end items-center">
                                ...
                                <LabaratoryThemeToggle setTheme1={setTheme1} />
                            </div>
                        </div>
                    </div>
...
export default LabaratoryLayout;
