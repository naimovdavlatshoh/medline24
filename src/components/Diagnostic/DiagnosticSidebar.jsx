...
const DiagnosticSidebar = ({ active, setActive }) => {
        ...
        >
            ...
            <ul>
                ...
                <li
                    ...
                    className={`mb-2 px-3 py-3 rounded-xl rounded-ee-[40px]  ${
                        currenurl == "/diagnostic-ambulator-patients"
                            ? "bg-main-green text-white"
                            : "text-main-green"
                    }`}
                >
                    <Link
                        to="/diagnostic-ambulator-patients"
                        className={`flex gap-2   justify-${
                            sidebar ? "start" : "center"
                        }`}
                    >
                        <IoPeopleSharp size={25} />
                        {sidebar ? "Амбулаторные пациенты" : ""}
                    </Link>
                </li>
                <li
                    onClick={() => {
