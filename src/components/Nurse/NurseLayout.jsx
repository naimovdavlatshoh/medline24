...
import NurseThemeToggle from "./NurseThemeToggle";
    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex flex-col flex-grow">
                    ...
                    <div className="h-[10vh]">
                        <NurseNavbar setTheme1={setTheme1} />
                    </div>
            ...
            >
                ...
                >
                    <NurseSidebar active={active} setActive={setActive} />
                </div>
                    ...
                    <div className="h-[10vh] ">
                        <div className="bg-theme-bg text-theme-text flex items-center justify-between px-3 h-[80px] transition-all duration-300">
                            ...
                            <div className="flex justify-end items-center">
                                ...
                                <NurseThemeToggle setTheme1={setTheme1} />
                            </div>
                        </div>
                    </div>
